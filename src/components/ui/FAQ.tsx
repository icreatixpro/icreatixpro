...
const faqs = [
  ...
  {
    question: "What makes your AI SEO different from traditional SEO?",
    answer: "Our AI SEO approach uses machine learning algorithms to analyze search patterns, predict ranking factors, and automate optimizations. This allows us to adapt faster to algorithm changes and identify opportunities that traditional methods might miss."
  },
  {
    question: "Do you guarantee first-page rankings?",
    answer: "While no ethical SEO agency can guarantee specific rankings due to search engine algorithms constantly changing, we guarantee to implement proven strategies that have consistently helped our clients achieve significant improvements in their search visibility and organic traffic."
  }
]
