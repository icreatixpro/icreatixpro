      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-[#2C727B]/10 to-[#1A394E]/10 rounded-full px-4 py-2 mb-6">
            ...
            <span className="text-sm font-medium text-[#1A394E]">Navigation Guide</span>
          </div>
          ...
          <p className="text-[#1A394E]/60 text-lg max-w-2xl mx-auto">
            Complete website navigation guide. Find everything you need in one place.
          </p>
        </motion.div>
        ...
        >
          {[
            { label: "Total Pages", value: 35, icon: FileText },
