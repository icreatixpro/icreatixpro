...
import {
  ...
  Rocket, Star, Calendar, ChevronRight, Heart,
  Target, LineChart, Code, FileText,
  ShoppingBag, Mail, Bot, Server, Building2
} from "lucide-react";
    ...
    services: [
      {
        ...
        title: "SEO Services",
        description: "Data-driven search engine optimization that ranks your business #1 on Google.",
        icon: Search,
        price: "$499/mo",
      ...
      },
      {
        slug: "local-seo",
        title: "Local SEO",
        description: "Dominate Google Maps and local pack results to capture nearby customers.",
        icon: MapPin,
        price: "$299/mo",
      ...
      },
      {
        ...
        description: "Specialist London SEO agency for B2B tech, SaaS & enterprises.",
        icon: Building2,
        price: "$599/mo",
      ...
      },
      {
        ...
        description: "Increase product page rankings and drive more online sales.",
        icon: ShoppingBag,
        price: "$599/mo",
  ...
  },
  {
    ...
    services: [
      ...
      },
      {
        ...
        description: "Get your brand cited inside ChatGPT, Gemini & Perplexity AI answers.",
        icon: Globe,
        price: "$799/mo",
      ...
      },
      {
        ...
        description: "High‑ticket SEO for B2B platforms and product-led growth companies.",
        icon: Server,
        price: "$999/mo",
    ...
    services: [
      {
        ...
        description: "Drive high‑intent traffic with pay‑per‑click campaigns optimized for ROAS.",
        icon: BarChart3,
        price: "$599/mo + spend",
      ...
      },
      {
        slug: "meta-ads",
        title: "Meta Ads",
        description: "Scale sales with data-driven Facebook & Instagram advertising.",
        icon: Target,
        price: "$499/mo + spend",
...
const testimonials = [
  ...
  },
  {
    ...
    content: "E‑commerce sales doubled after they optimized our product pages and implemented advanced structured data.",
...
const differentiators = [
  { title: "AI‑First Approach", desc: "We optimize for Google and AI engines simultaneously.", icon: Bot },
...
// ========== SIMPLIFIED LAZY SECTION (NO HYDRATION ISSUES) ==========
...
export default function ServicesClient() {
  ...
  // Hero fade-in (safe, no hydration mismatch)
  useEffect(() => {
    const timer = setTimeout(() => setHeroVisible(true), 50);
    return () => clearTimeout(timer);
  }, []);

  // Rotating words (no key remount)
  useEffect(() => {
  ...
  return (
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description: "AI SEO & GEO Agency for B2B Tech Companies, SaaS Startups, and Enterprise Brands.",
            serviceType: "SEO Agency",
            areaServed: ["USA", "UK", "UAE", "Europe", "Australia"],
            knowsAbout: ["Search Engine Optimization", "Generative Engine Optimization", "SaaS Technical SEO", "Google Ads", "Meta Ads"],
            aggregateRating: {
      ...
      <main className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100" suppressHydrationWarning>
        {/* ========== HERO ========== */}
        <section className="relative overflow-hidden pt-0 pb-16 md:pt-0 md:pb-20 px-6">
          {/* Background blobs */}
          <div className="absolute top-0 right-0 w-72 h-72 bg-[#2C727B]/20 rounded-full blur-3xl opacity-40 animate-pulse pointer-events-none" />
          ...
          >
            <div className="flex items-center justify-center gap-2 mt-4 text-sm text-gray-600">
              ...
              <span>Rated <strong>4.9/5</strong> based on <strong>127 client reviews</strong></span>
            </div>

            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/90 backdrop-blur-sm border border-[#2C727B]/20 shadow-sm mb-6 mt-6">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold leading-tight tracking-tight mb-6">
              <span className="block text-[#1A394E]">AI SEO & GEO Agency for</span>
              <span className="block mt-2 bg-gradient-to-r from-[#2C727B] via-[#1A394E] to-[#2C727B] bg-clip-text text-transparent transition-all duration-300">
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-6">
              <Link
                href="/contact"
                className="group inline-flex items-center px-8 py-3.5 bg-[#2C727B] text-white font-semibold rounded-lg shadow-md hover:shadow-xl hover:bg-[#1A394E] transition-all duration-300 hover:-translate-y-0.5"
              >
              ...
              <Link
                href="#services"
                className="group inline-flex items-center px-8 py-3.5 border-2 border-[#2C727B] text-[#2C727B] font-semibold rounded-lg hover:bg-[#2C727B] hover:text-white transition-all duration-300"
              >
                Explore Services
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                  {cluster.services.map((service) => {
                    ...
                    return (
                      ...
                      >
                        <div className={`h-1.5 bg-gradient-to-r ${cluster.gradient} transition-all duration-300 ${hoveredServiceSlug === service.slug ? "h-2" : "h-1.5"}`} />
            ...
            <div className="relative overflow-hidden bg-gradient-to-br from-[#2C727B] to-[#1A394E] rounded-3xl p-8 md:p-10 text-center shadow-2xl">
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-wrap justify-center gap-4">
                  <Link
                    href="/contact"
                    className="inline-flex items-center px-8 py-3.5 bg-white text-[#1A394E] font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-0.5"
                  >
                  ...
                  <Link
                    href="#services"
                    className="inline-flex items-center px-8 py-3.5 bg-white/10 backdrop-blur-sm border border-white/30 text-white font-semibold rounded-lg hover:bg-white/20 transition-all duration-300"
                  >
                    Explore Services
