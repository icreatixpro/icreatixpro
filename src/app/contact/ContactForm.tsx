...
// ============================================
// CONTACT INFO - UPDATED (Google Maps Link Removed)
// ============================================
...
const contactInfo = [
  {
    ...
    details: ["United States", "United Kingdom", "United Arab Emirates", "Australia", "Canada", "France", "Germany"],
    action: null  // ✅ REMOVED - "Get Directions" button (maps.google.com link hata diya)
  },
  {
    icon: Phone,
    title: "Call Us",
  ...
  },
  {
    ...
    details: ["Monday-Friday: 9AM - 6PM EST", "Saturday: 10AM - 2PM EST", "Sunday: Closed"],
    action: null
  }
];
...
const faqs = [
  ...
  { q: "What industries do you specialize in?", a: "We work with businesses across e-commerce, healthcare, real estate, technology, hospitality, professional services, and local businesses globally." },
...
export default function ContactForm() {
  ...
  return (
    <>
      {/* ✅ Server-side schema already in metadata, this is backup */}
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "ContactPage",
            name: "Contact iCreatixPRO | Global Digital Marketing Agency",
            description: "Get in touch with iCreatixPRO for SEO, Google Ads, and digital marketing services. Free consultation available.",
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-[#1A394E] mb-4">
                ...
                <span className="bg-gradient-to-r from-[#2C727B] to-[#1A394E] bg-clip-text text-transparent">
                  Contact SEO Experts Get Free Digital Marketing Consultation
                </span>
              </h1>
